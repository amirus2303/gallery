            ...
            <div class="modal-body">
                        ...
                        <?php foreach ($photos as $photo) : ?>
                            ...
                            <div class="col-xs-2">
                                <a role="checkbox" aria-checked="false" tabindex="0" id="" href="#" class="thumbnail">
                                   <img class="modal_thumbnails img-responsive" src="<?php echo $photo->picture_path(); ?>" data-image-id="<?php echo $photo->id; ?>" data-image-name="<?php echo $photo->filename; ?>">
                                </a>
                                <div class="photo-id hidden"><?php echo $photo->id; ?></div>
                            </div>
                        <?php endforeach; ?>
                        <!-- PHP LOOP HERE CODE HERE-->
                ...
                <div class="col-md-3">
                    <div id="modal_sidebar">
                        <p>Filename : <span class="filename"></span></p>
                        <p>Type : <span class="type uppercase"></span></p>
